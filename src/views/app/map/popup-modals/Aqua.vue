      ...
      <b-col lg="12">
        <b-tabs content-class="mt-1" fill>
          <b-overlay :show="!isShow" rounded="sm">
                ...
                <div class="d-flex flex-column flex-lg-row gap-3">
                  <div class="light-box-left-modal">
                    ...
                    <div class="mb-2">
                      ...
                      >
                        {{ $t("tabs.title.detail-device").toUpperCase() }}
                      </div>
                      <div style="max-height: 16vh; overflow-y: auto">
                        <template
                          v-if="
                        ...
                        >
                          <template
                            v-for="(_item, i) in dataModal.DeviceInfoProperties"
                          >
                            <div :key="'itemB' + i">
                              <div
                    ...
                    <div class="mt-2">
                      <div>
                        <div class="d-flex flex-column">
                          <div class="mb-2">
                            <div
                              class="font-size-custom pb-1 border-bottom text-capitalize"
                            >
                              {{
                                $t(
                                  "tabs.title.general-information"
                                ).toUpperCase()
                              }}
                            </div>
                  ...
                  <div class="light-box-right-modal">
                    ...
                    >
                      {{
                        $t("dashboards.monitor.device-operation").toUpperCase()
                      }}
                    </div>
                    <div class="light-grid-dashboard mt-2 mb-4">
                      <div class="d-flex flex-row align-items-center">
                        <b-img
                          :src="require('@/assets/img/aqua-icon/error.png')"
                          style="height: 32px"
                          class="mr-2"
                        ></b-img>
                        <div class="d-flex flex-column">
                          <h3 class="font-weight-bold mb-0 pb-0">0</h3>
                          <p
                            class="text-small text-muted font-weight-bold mb-0"
                          >
                            {{ $t("badge.error-device") }}
                          </p>
                        </div>
                      </div>
                      <div class="d-flex flex-row align-items-center">
                        <b-img
                          :src="
                            require('@/assets/img/aqua-icon/line-chart-error.png')
                          "
                          style="height: 32px"
                          class="mr-2"
                        ></b-img>
                        <div class="d-flex flex-column">
                          ...
                          <p
                            class="text-small text-muted font-weight-bold mb-0"
                          >
                            {{ $t("tabs.title.error-index") }}
                          </p>
                        </div>
                      </div>
                      <div class="d-flex flex-row align-items-center">
                        <b-img
                          :src="require('@/assets/img/aqua-icon/warning.png')"
                          style="height: 32px"
                          class="mr-2"
                        ></b-img>
                        <div class="d-flex flex-column">
                      ...
                      <div class="d-flex flex-row align-items-center">
                        <b-img
                          :src="
                            require('@/assets/img/aqua-icon/line-chart-warning.png')
                          "
                          style="height: 32px"
                          class="mr-2"
                        ></b-img>
                        <div class="d-flex flex-column">
                          ...
                          <p
                            class="text-small text-muted font-weight-bold mb-0"
                          >
                            {{ $t("tabs.title.error-warning") }}
                          </p>
                        </div>
                      </div>
                      <div class="d-flex flex-row align-items-center">
                        <b-img
                          :src="require('@/assets/img/aqua-icon/close.png')"
                          style="height: 32px"
                          class="mr-2"
                        ></b-img>
                        <div class="d-flex flex-column">
            ...
            >
              <div
                class="d-flex flex-md-row flex-column justify-content-end mt-4"
              >
                <div style="width: 250px" class="mx-auto mr-md-3">
                  <b-form-group>
                    <b-form-select
                      style="
                        height: calc(2.3rem);
              ...
              <b-row>
                <b-col md="12" lg="6" class="mb-3 mt-2 text-right" v-if="false">
                  <b-row>
                    <b-col md="12" lg="6">
                      <b-form-group>
                        <b-form-select
                ...
                <template v-if="dataNodeCharts && dataNodeCharts.length > 0">
            ...
            <b-tab :title="$t('list-image-setting').toUpperCase()">
              <b-row v-if="dataImages && dataImages.length > 0" class="mt-4">
              ...
              <template v-else>
                <p class="text-center text-muted text-small font-italic mt-4">
                  {{ $t("map.no-data") }}
                </p>
              </template>
            </b-tab>
...
export default {
  ...
  props: ["dataParent", "objectData", "reloadData"],
  name: "Aqua",
  data() {
    return {
      ...
      dataNodeCharts: null,
      // module-img
      keyString: this.dataParent.DataTypeName ?? "Aqua",
      dataImages: null,
      listImage: null,
      itemSelected: null,
      optionItem: null,
  ...
  created() {
    //custom-range
    let ListIndicator = this.dataModal ? this.dataModal.ListIndicator : null;
    this.rangeColorValues = [];
    ListIndicator.map((it) => {
      if (it.Properties && it.Properties.length > 0) {
        this.rangeColorValues.push({
