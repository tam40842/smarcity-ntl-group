      ...
      >
        ...
        >
          ...
          <template v-else>
              ...
              <template v-if="objKey.custom.toUpperCase() === 'CUSTOM'">
                <template v-if="row.item[objKey.ClName] > 0">
                  <b-badge
                    ...
                    pill
                  >
                    {{ row.item[objKey.ClName] }} / {{ row.item.StationTotal }}
                  </b-badge>
                </template>
                <template v-if="row.item[objKey.ClName] == 0">
                  <b-badge
            ...
            <!-- <template
              v-else-if="objKey.ClName.toUpperCase() === 'STATIONDISCONNECT'"
            >
              <button class="button2">{{ row.item[objKey.ClName] }}</button>
            </template>

            <template
              v-else-if="objKey.ClName.toUpperCase() === 'STATIONERROR'"
            >
              <button class="button3">{{ row.item[objKey.ClName] }}</button>
            </template>

            <template
              v-else-if="objKey.ClName.toUpperCase() === 'STATIONLOWPIN'"
            >
              <button class="button4">{{ row.item[objKey.ClName] }}</button>
            </template>

            <template
              v-else-if="objKey.ClName.toUpperCase() === 'STATIONTOTAL'"
            >
