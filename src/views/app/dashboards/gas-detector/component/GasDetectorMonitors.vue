...
import GasRestaurantPopup from "@/views/app/map/popup-modals/GasDetectorDetail";
...
export default {
  ...
  watch: {
    ...
    items() {
      this.getColumn("MonitorByGasDetector");
    },
  },
  methods: {
    changeOption(store) {
  ...
  async created() {
    ...
    await this.getColumn("MonitorByGasDetector");
    await this.getKeyTable();
    await this.timeLoadData(this.timer * 10);
  },
  computed: {
    fields: function () {
