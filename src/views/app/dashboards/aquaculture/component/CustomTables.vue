  ...
  <div class="custom-table-aqua">
    <template v-if="dataTable && dataTable.length > 0">
      ...
      <b-table
        ...
        thead-tr-class="vertical-align-middle"
      >
        <template
        ...
        >
          ...
          <template v-else>
            ...
            <template
              v-else-if="
                objKey.TypeCol.toUpperCase() == 'STRINGCENTER' &&
                objKey.ClName.toUpperCase() !== 'DESCRIPTIONWARNING' &&
                objKey.ClName.toUpperCase() !== 'UPDATETIME'
              "
            >
              <template v-if="objKey.ClName.toUpperCase() === 'SLNODE'">
              </template>
              <template v-else>
                <template
                  v-if="
                    objKey.ClName.toUpperCase() === 'SLERROR' ||
                    objKey.ClName.toUpperCase() === 'SLWARNNING'
                  "
                >
                  <b-badge
                    :key="key"
                    ...
                    :style="{
                      background:
                        parseFloat(row.item[objKey.ClName]) > 0
                          ? 'orange !important'
                          : 'green !important',
                    }"
                    >{{ row.item[objKey.ClName] }} /
                    {{ row.item.SLNode }}</b-badge
                  >
                </template>
                <template v-else>
                  <b-badge
                    ...
                    >{{ row.item[objKey.ClName] }}</b-badge
                  >
                </template>
              </template>
            </template>
