  ...
  <div class="table-dashboard-led">
    <template v-if="dataTable && dataTable.length > 0">
      ...
      <b-table
        ...
        :fields="fieldTable"
        :items="dataTable"
        :class="!borderedCurrent && 'add-border-bottom'"
        @filtered="onFiltered"
        :filter="filter"
        ...
        thead-tr-class="white-space-nowrap"
        tbody-tr-class="white-space-nowrap"
        show-empty
      >
        <template
          ...
          >
            ...
            <template v-else>
              <b-form-checkbox
                ...
                size="md"
              ></b-form-checkbox>
              <div class="frame-status" v-else :key="key">
                <b-form-checkbox
                  v-model="row.item[objKey.ClName]"
                  switch
                  size="md"
        ...
        <template #cell(Detail)="row">
          <div
            ...
            @click.stop="emitRowDblclicked(row.item)"
          >
