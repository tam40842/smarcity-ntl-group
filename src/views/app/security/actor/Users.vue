  ...
  methods: {
    ...
    editModal(items) {
      ...
      setTimeout(() => {
        ...
        this.dataForm.IsSale[1] = handling.convertBitToBoolean(
          this.dataForm.IsSale[1]
        );
        setTimeout(() => {
          this.$bvModal.show(this.nameForm);
        }, this.timer);
    ...
    deleteModal(items) {
      this.$bvModal
        .msgBoxConfirm(this.$t("form.question") + items[0].UserFullName + "?", {
