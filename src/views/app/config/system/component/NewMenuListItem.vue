  ...
  <b-row>
    <template v-if="type === 'Menu'">
      <template v-for="(item, index) in data" v-if="data.length > 0">
        <b-colxx cols="12" class="" :key="index" :id="item.id">
          <b-card
            :class="{
          ...
          >
            <div class="d-flex flex-grow-1 min-width-zero">
              <div
                class="custom-control pl-0 align-self-center pr-2 pt-1 pb-1"
              ...
              <div
                class="custom-control custom-checkbox pl-2 align-self-center pr-2"
...
export default {
  ...
  beforeCreate: function () {
    this.$options.components.MenuItemComponent =
      require("./NewMenuItem.vue").default;
  },
  data() {
    return {
      testActive: false,
