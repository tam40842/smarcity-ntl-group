<template>
  <div v-if="objectData" class="category-led-station">
    <b-row>
      <b-colxx xxs="12">
        <h1>
...
//   getDataTypeByID,
//   regionList,
// } from '@/api/modules/systemAPI'
// import {
//   getLedStationsList,
//   getLedStationsByID,
//   ledStationsChangeStatus,
//   ledStationsRemove,
// } from '@/api/modules/ledAPI'

// import { uploadImagesBase64, getImagesByID } from '@/api/modules/systemAPI'
...
export default {
  ...
  methods: {
    ...
    handleSubmitUpdate() {
      let body = {
        ...
        GeoCode: this.keyString,
        Base64Strings: this.listImageBase64.map(
          (item) =>
            // item.Images.replace('data:image/jpeg;base64,', ''),
            item.Images.split(";base64,")[1]
        ),
      };
      systemAPI
    ...
    editModal(items) {
      ...
      // this.getOptionDataTypeID('SmartLed')
      ...
      setTimeout(() => {
        ...
        this.typeForm = "EDIT";
        // this.apiForm = '/api/LedStations/Deploy' //fix
        this.apiForm = "/api/LedStations/Edit"; //fix
    ...
    convertKeyTableData(array, ParentID, arrayTable = [], i) {
      array.forEach((item) => {
        ...
        let obj = {
          ID: item["RegionID"],
          ParentID: item["RegionParentID"],
          FireLocationName: item["RegionName"],
  ...
  async created() {
    ...
    await this.getColumn("LedStations");
    await this.getKeyTable();
    await this.getData();
    await this.getFormAddShow("LedStations");
    await this.getOptionConnectType();
    await this.getOptionPowerType();
    await this.getOptionDataTypeID("SMARTLED");
