...
import insectAPI from "@/api/modules/insectAPI";
...
export default {
  ...
  methods: {
    ...
    addModal() {
      ...
      this.typeForm = "ADD";
      this.apiForm = "/api/InsectOneStations/Add";
    ...
    editModal(items) {
      ...
      setTimeout(() => {
        ...
        this.typeForm = "EDIT";
        this.apiForm = "/api/InsectOneStations/Edit";
        this.bodyFormDefault = {
  ...
  async created() {
    ...
    await this.getColumn("InsectOnes");
    await this.getKeyTable();
    await this.getData();
    await this.getFormAddShow("InsectOnes");
