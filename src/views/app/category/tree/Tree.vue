...
import CustomFormTree from "./component/FormTree";
            ...
            if (val.data.length > 0) {
              ...
              for (let i = 0; i < val.data.length; i++) {
                if (val.data[i].IsActive === 1) {
                  let obj = {
                    text: val.data[i].ColorName,
                    value: val.data[i].ColorID,
                  };
          ...
          if (val.status) {
            if (val.data.length > 0) {
              ...
              for (let i = 0; i < val.data.length; i++) {
                if (val.data[i].IsActive === 1) {
                  let obj = {
                    text: val.data[i].LeafName,
                    value: val.data[i].LeafID,
                  };
          ...
          if (val.status) {
            if (val.data.length > 0) {
              ...
              for (let i = 0; i < val.data.length; i++) {
                if (val.data[i].IsActive === 1) {
                  let obj = {
                    text: val.data[i].CrownName,
                    value: val.data[i].CrownID,
                  };
          ...
          if (val.status) {
            if (val.data.length > 0) {
              ...
              for (let i = 0; i < val.data.length; i++) {
                if (val.data[i].IsActive === 1) {
                  let obj = {
                    text: val.data[i].TreeCategorieName,
                    value: val.data[i].TreeCategorieID,
                  };
          ...
          if (val.status) {
            if (val.data.length > 0) {
              ...
              for (let i = 0; i < val.data.length; i++) {
                if (val.data[i].IsActive === 1) {
                  let obj = {
                    text: val.data[i].TreeGroupName,
                    value: val.data[i].TreeGroupID,
                  };
