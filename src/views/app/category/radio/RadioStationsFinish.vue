...
import radioAPI from "@/api/modules/radioAPI.js";
  ...
  methods: {
    ...
    handleSubmitUpdate() {
      let body = {
        ...
        GeoCode: this.keyString,
        Base64Strings: this.listImageBase64,
        // .map((item) =>
    ...
    addModal() {
      ...
      this.apiForm = "/api/RadioStations/Export";
      setTimeout(() => {
    ...
    editModal(items) {
      ...
      setTimeout(() => {
        ...
        // this.dataForm.StationExtention1[1] = ''
        // console.log(1, this.dataForm.StationExtention1[1], this.dataByID)
    ...
    getDataByID(id) {
      let body = {
        ID: id, // dùng Aqua chung thì đổi key thành ID
        //DataTypeID: 5028, // a.đức -> gán cứng
      };
      radioAPI
        .getRadioByID(body)
        .then((val) => {
