...
export default {
  ...
  methods: {
    ...
    addModal() {
      ...
      this.typeForm = "ADD";
      this.apiForm = "/api/FireStations/Add";
    ...
    editModal(items) {
      ...
      setTimeout(() => {
        ...
        this.nameForm = "modal-edit-fire-station";
        this.titleForm = this.$t("form.title-edit").toUpperCase();
        this.typeForm = "EDIT";
        this.apiForm = "/api/FireStations/Edit";
        this.bodyFormDefault = {
  ...
  async created() {
    ...
    await this.getKeyTable(this.data.ID);
