            ...
            >
              ...
              >
                <b-colxx md="6">
                    ...
                    <b-form-group :label="dataForm[items][0] + ':'">
                      ...
                      >
                        ...
                        <template v-else>
                          ...
                          <template
                            v-else-if="
                              dataForm[items][4] && dataForm[items][4] === 'LOA'
                            "
                          ></template>
                  ...
                  >
                    <template v-if="items.toUpperCase() == 'LOCATIONID'">
                      <b-form-group :label="dataForm[items][0] + ':'">
                        <b-form-select
                          v-model="dataForm[items][1]"
                    ...
                    <b-form-group :label="dataForm[items][0] + ':'">
                      ...
                      <template
                        v-if="
                          ...
                          (dataForm[items][1] && dataForm[items][1].length > 0)
                        "
                      >
                        <div class="box">
                          <carousel
                          ...
                          >
                                  ...
                                  >
                                    ...
                                    <b-badge
                                      style="
                                        ...
                                        cursor: pointer;
                                      "
                                      @click.stop.prevent="remove(i, 'BASE64')"
                                    >
                                      X
                                    </b-badge>
                                  </div>
                            ...
                            <template
                              ...
                              "
                            >
                              <template v-for="(img, i) in dataForm[items][1]">
                  ...
                  <template
                    v-else-if="dataForm[items][2].toUpperCase() === 'ID-PARENT'"
                  >
                    <b-form-group :label="dataForm[items][0] + ':'">
                      <b-form-input
                        id="name-input"
...
export default {
  ...
  methods: {
    ...
    handleChange(item, option) {
      ...
      this.$emit('changeStation', item[1])
      ...
      //     console.log(arr);
      //     this.locationOptions = arr.map((item) => ({
      //       value: item.ID,
    ...
    resetModal() {
      ...
      this.$bvModal.hide("custom-table-report-fire-station");
    },
    ...
    convertBody(body) {
      if (body.hasOwnProperty("IsSpeaker")) {
        body.IsSpeaker = handling.convertBooleanToBit(body.IsSpeaker);
      }
    },
