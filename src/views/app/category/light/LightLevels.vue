                ...
                <template #cell(IsActive)="row">
                  <template v-if="row.item.IsActive == '1'">
                    <div :style="'padding-left: 35%;'">
                      <div
                        class="has-use"
                        :style="'border: 2px solid; color: green; padding-top:3px '"
                      >
                  ...
                  <template v-else>
                    <div :style="'padding-left: 35%; '">
                      ...
                      >
                        <div
                          :style="'color: black; font-weight: 600; padding-top:3px'"
                        >
                          Không dùng
                        </div>
                      </div>
...
export default {
  components: {
    ...
    ActionsFooterNPL,
    TableListFile,
    "form-history": FormHistoryLightLevels,
  ...
  data() {
    return {
      ...
      notRequired: ["Note", "IsActive", "LightNameExtention1"],
