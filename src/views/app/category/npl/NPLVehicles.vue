...
export default {
  ...
  data() {
    return {
      apiGet: "/api/nPLVehicles/Get",
      apiGetById: "/api/nPLVehicles/GetById",
      apiAdd: "/api/nPLVehicles/Add",
      apiEdit: "/api/nPLVehicles/Edit",
      apiDelete: "/api/nPLVehicles/Delete",
    }
  },
  created() {
      ...
      nplAPI
        ...
        .then((val) => {
          ...
          if (obj) {
            ...
            if(newObj.VehicleDevices) {
              newObj.VehicleDevices[1] = newObj.VehicleDevices[1].split(",")
            }
