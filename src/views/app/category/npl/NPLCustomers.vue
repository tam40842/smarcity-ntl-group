...
export default {
  ...
  data() {
    return {
      ...
      apiGet: "/api/nPLCustomers/Get",
      apiGetById: "/api/nPLCustomers/GetById",
      apiAdd: "/api/nPLCustomers/Add",
      apiEdit: "/api/nPLCustomers/Edit",
      apiDelete: "/api/nPLCustomers/Delete",
    };
  },
  created() {
