...
export default {
  ...
  methods: {
    ...
    //               value: val.data[i].ID,
    //             }
    //             this.dataFormOptions.Name.push(obj)
    //           }
    //         }
    //       }
    //     })
    ...
    addModal() {
      ...
      this.sizeModal = "lg";
      // this.dataForm[0].type = 'NUMBER'
      // this.dataForm[0].value = 0
      setTimeout(() => {
        this.$bvModal.show(this.idModal);
      }, 500);
    },
