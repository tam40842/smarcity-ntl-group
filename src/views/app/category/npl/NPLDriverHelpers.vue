...
export default {
  ...
  data() {
    return {
      ...
      apiGet: "/api/NPLDriveHelpers/Get",
      apiGetById: "/api/NPLDriveHelpers/GetById",
      apiAdd: "/api/NPLDriveHelpers/Add",
      apiEdit: "/api/NPLDriveHelpers/Edit",
      apiDelete: "/api/NPLDriveHelpers/Delete",
    };
  },
  created() {
