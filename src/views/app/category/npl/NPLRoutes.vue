          ...
          <b-tab>
            ...
            <div class="box-content mt-2" :style="{ height: heightContent2 }">
              <component
                ...
                @changeCheckRouteID="changeCheckRouteID"
              />
            </div>
          </b-tab>
          <b-tab>
...
export default {
  ...
  data() {
    return {
      ...
      apiGet: "/api/nPLRoutes/Get",
      apiGetById: "/api/nPLRoutes/GetById",
      apiAdd: "/api/nPLRoutes/Add",
      apiEdit: "/api/nPLRoutes/Edit",
      apiDelete: "/api/nPLRoutes/Delete",
    };
  },
  watch: {
    dataForm() {
  ...
  methods: {
    changeCheckRouteID(value) {
      this.checkRouteID = value;
    },
  },
};
</script>
