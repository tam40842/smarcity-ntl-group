        ...
        <b-row>
          <b-col lg="2">
            <b-row>
              <b-col lg="12">
                <b-form-group
                  :label="dataForm.DailyFare[0]"
                  :invalid-feedback="$t('form.no-blank')"
                  :state="dataForm.DailyFare[3]"
                >
                  <b-form-input
                    v-model="dataForm.DailyFare[1]"
                    :disabled="
                      currentMode === 'adding' || currentMode === 'editing'
                        ? false
                        : true
              ...
              <b-col lg="12">
                <b-form-group
                  :label="dataForm.MonthlyFare[0]"
                  :invalid-feedback="$t('form.no-blank')"
                  :state="dataForm.MonthlyFare[3]"
                >
                  <b-form-input
                    v-model="dataForm.MonthlyFare[1]"
                    :disabled="
                      currentMode === 'adding' || currentMode === 'editing'
                        ? false
                        : true
