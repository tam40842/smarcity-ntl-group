  ...
  <div>
    <b-row>
      <b-col lg="2">
        ...
        >
          <b-form-input v-model="dataForm.LemonID[1]"></b-form-input>
        </b-form-group>
      </b-col>
      <b-col lg="6">
        <b-form-group
    ...
    <b-row>
      ...
      <b-col lg="4">
        <b-form-group
          :label="dataForm.Position[0]"
          :invalid-feedback="$t('form.no-blank')"
          :state="dataForm.Position[3]"
        >
          <b-form-input v-model="dataForm.Position[1]"></b-form-input>
        </b-form-group>
      </b-col>
      <b-col lg="4">
        <b-form-group
          :label="dataForm.ChargeJobID[0]"
          :invalid-feedback="$t('form.no-blank')"
          :state="dataForm.ChargeJobID[3]"
        >
          <b-form-select
            v-model="dataForm.ChargeJobID[1]"
            :options="dataFormOptions.ChargeJobID"
          ></b-form-select>
        </b-form-group>
      </b-col>
      <b-col lg="12">
...
<script>
import dataFormOptions from "@/views/app/category/npl/mixin/dataFormOptionsMixin";
