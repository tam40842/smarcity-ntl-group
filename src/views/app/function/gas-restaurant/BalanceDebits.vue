...
import CustomForm from "./component/BalanceDebitsForm";
...
export default {
  ...
  methods: {
    ...
    addFileModal() {
      ...
      this.apiForm = "/api/BalanceDebits/AddWithExcel";
    ...
    addModal() {
      ...
      this.titleForm = this.$t("form.title-add").toUpperCase();
      this.typeForm = "ADD";
      this.apiForm = "/api/BalanceDebits/Add";
      this.bodyFormDefault = {
        MenuIDCurent: this.objectData.menuIDCurrent,
      };
      setTimeout(() => {
    ...
    editModal(items) {
      ...
      setTimeout(() => {
        ...
        this.typeForm = "EDIT";
        this.apiForm = "/api/BalanceDebits/Edit";
        this.bodyFormDefault = {
          MenuIDCurent: this.objectData.menuIDCurrent,
        };
        setTimeout(() => {
