<template>
  <div class="main">
    ...
    <b-button
      ...
      variant="warning"
      size="xs"
      :disabled="isAdd || selectedItem && selectedItem.IsActive.value == 1 ? true : false"
    ...
    <b-button
      ...
      variant="danger"
      size="xs"
      :disabled="isAdd || isEdit || selectedItem && selectedItem.IsActive.value == 1 ? true : false"
    ...
    >
      <i
        ...
        "
      />
      <b v-if="selectedItem && selectedItem.IsActive.value == 0" class="text-success">
        Khóa
      </b>
