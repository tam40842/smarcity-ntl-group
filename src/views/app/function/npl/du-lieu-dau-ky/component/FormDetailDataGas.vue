        ...
        <b-row>
          <b-col lg="6">
            <b-row>
              ...
              <b-col lg="6">
                <b-form-group
                  :label="dataForm.GasLastKm[0]"
                  :invalid-feedback="$t('form.no-blank')"
                  :state="dataForm.GasLastKm[3]"
                  :disabled="
                    currentMode === 'adding' || currentMode === 'editing'
                      ? false
                      : true
                ...
                >
                  <b-form-input 
                    v-model="dataForm.GasLastKm[1]"
                  />
                </b-form-group>
              </b-col>
              <b-col lg="6">
                <b-form-group
                  :label="dataForm.GasLastQuantity[0]"
                  :invalid-feedback="$t('form.no-blank')"
                  :state="dataForm.GasLastQuantity[3]"
                  :disabled="
                    currentMode === 'adding' || currentMode === 'editing'
                      ? false
                      : true
                ...
                >
                  <b-form-input 
                    v-model="dataForm.GasLastQuantity[1]"
                  />
                </b-form-group>
              </b-col>
            </b-row>
