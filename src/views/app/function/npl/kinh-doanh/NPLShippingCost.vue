...
export default {
  ...
  data() {
    return {
      apiGet: "/api/ShippingAndCreditnPL/Get",
      apiGetById: "/api/ShippingAndCreditnPL/GetById",
      apiAdd: "/api/ShippingAndCreditnPL/Add",
      apiEdit: "/api/ShippingAndCreditnPL/Edit",
      apiDelete: "/api/ShippingAndCreditnPL/Delete",
      apiCopy: "/api/ShippingAndCreditnPL/Copy",
      apiChangeStatus: "/api/ShippingAndCreditnPL/ChangeStatus",
    };
  },
  created() {
