...
export default {
  ...
  data() {
    return {
      apiGet: "api/OilAllowances/Get",
      apiGetById: "api/OilAllowances/GetById",
      apiAdd: "api/OilAllowances/Add",
      apiEdit: "api/OilAllowances/Edit",
      apiDelete: "api/OilAllowances/Delete",
      apiCopy: "api/OilAllowances/Copy",
      apiChangeStatus: "/api/OilAllowances/ChangeStatus",
    };
  },
  created() {
