<template>
  <div class="form-basic">
      ...
      <b-tab
        ><div class="box-content mt-2 custom-box-tab1">
          ...
          >
            ...
            <template v-slot:cell(DSCT)>
              <div class="text-center">
                <b-button
                  @click.prevent.stop="showModalDSCT"
                  style="padding: 0.28rem 1rem; border: 2px solid #17a2b8"
                  size="sm"
          ...
          <b-row>
            <b-col lg="6">
              <b-row v-if="typeFormHeader && typeFormHeader.length > 0">
                ...
                <b-colxx sm="3" class="d-flex align-items-center">
                  <b-form-checkbox class="pt-2">Xe tải ?</b-form-checkbox>
                </b-colxx>
                <b-colxx sm="12">
                ...
                <b-colxx sm="4">
                  <b-form-group
                    v-if="currentTitle.toUpperCase() == 'HÀNG RỜI'"
                    :label="'Số lượng'"
                  >
                    <div class="d-flex">
                      <b-form-input
                  ...
                  <b-form-group v-else :label="'Có chi hộ hay không ?'">
                ...
                <b-colxx sm="4">
                  ...
                  <b-form-group
                    v-else-if="currentTitle.toUpperCase() == 'CONT NHẬP'"
                    :label="'Cont kiểm hóa'"
                  >
                    <v-select
                      :options="[
                ...
                <b-colxx sm="12">
                  <div class="mb-1">
                    <strong>THÔNG TIN XUẤT HÓA ĐƠN VẬN CHUYỂN</strong>
                    <b-button
                      class="ml-1"
                      squared
                  ...
                  >
                    <template #cell(Name)="row">
                      <div>
                        <span class="text-danger">{{ row.item.Name }}</span>
                      </div>
                    </template>
                  </b-table>
                </b-colxx>
              ...
              <b-row v-else-if="currentTitle.toUpperCase() == 'CONT NHẬP'">
                ...
                <b-col lg="2">
                  <b-form-group label="Tổng cont20" class="mt-2">
                    <b-form-input class="text-right" value="2" disabled>
                    </b-form-input>
                  </b-form-group>
                  <b-form-group label="Tổng cont40">
                    <b-form-input class="text-right" value="1" disabled>
                    </b-form-input>
                  </b-form-group>
                </b-col>
                <b-col lg="12">
        ...
        <b-tabs v-model="currentTabForm" content-class="mt-3" fill>
          <b-tab title="CHỌN DỮ LIỆU">
            <b-row>
              ...
              <b-col lg="2">
                <b-form-group label="SL cont20">
                  <b-form-input
                    class="text-right"
                    v-model="dataFormCX.SLcont20"
                  ></b-form-input>
                </b-form-group>
              </b-col>
              <b-col lg="2">
                <b-form-group label="SL cont40">
                  <b-form-input
                    class="text-right"
                    v-model="dataFormCX.SLcont40"
                  ></b-form-input>
                </b-form-group>
              </b-col>
              <b-col lg="4">
        ...
        <b-tabs v-model="currentTabForm" content-class="mt-3" fill>
          <b-tab title="CHỌN DỮ LIỆU">
            <b-row>
              ...
              <b-col lg="4">
                <b-form-group label="Công ty xuất hóa đơn">
                  <b-form-input v-model="dataFormCN.CtyXHD"></b-form-input>
                </b-form-group>
              </b-col>
              <b-col lg="4">
                <b-form-group label="Mã số thuế">
                  <b-form-input v-model="dataFormCN.MaSoThue"></b-form-input>
                </b-form-group>
              </b-col>
              <b-col lg="4">
                <b-form-group label="Địa chỉ">
              ...
              <b-col lg="12">
                <b-form-group label="Ghi chú">
                  <b-form-textarea v-model="dataFormCN.note"></b-form-textarea>
                </b-form-group>
              </b-col>
            </b-row>
          </b-tab>
    ...
    <b-modal id="modal-dsct" size="lg" centered title="DANH SÁCH CHỨNG TỪ">
      <div>
        <b-table
          responsive
          :fields="fDSCT"
          ...
          <template #cell(img)>
            <div class="text-center">
              <i
                ...
                @click.prevent.stop="showModalListIMG"
              ></i>
            </div>
          </template>
        </b-table>
      ...
      <div style="height: 600px; overflow: auto">
        <div style="height: 500px">
          <img
            ...
            src="http://indochina247.com/wp-content/uploads/2019/12/Bi%C3%AAn-lai-thu-ti%E1%BB%81n-l%E1%BB%87-ph%C3%AD.png"
          />
        </div>
        <div class="text-center text-muted mt-1">
          <strong>BIÊN LAI THU TIỀN PHÍ</strong>
        </div>
        <hr />
        <div style="height: 500px">
          <img
            v-img
            style="width: 100%; height: 100%"
            src="https://sanketoan.vn/public/library/images/file%20m%E1%BA%ABu%20ch%E1%BB%A9ng%20t%E1%BB%AB%2C%20b%C3%A1o%20c%C3%A1o/2905/5.PNG"
          />
        </div>
        <div class="text-center text-muted mt-1">
          <strong>BIÊN LAI THU TIỀN ...</strong>
        </div>
      </div>
    </b-modal>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      fieldsCNL: [
        ...
        {
          key: "CtyXHD1",
          label: "Công ty XHD nâng hạ",
        },
        {
          key: "MST1",
          label: "MST XHD nâng/hạ",
        },
        {
          key: "DiaChi1",
          label: "Địa chỉ XHD nâng/hạ",
        },
        {
          key: "CtyXHD2",
          label: "Công ty XHD phụ thu",
        },
        {
          key: "MST2",
          label: "MST XHD phụ thu",
        },
        {
          key: "DiaChi2",
          label: "Địa chỉ XHD phụ thu",
        },
        {
          key: "actions",
          label: "Thao tác",
      ...
      aDSCT: [
        {
          ID: "VD001",
          createDate: "10:30 25/12/2022",
          BSX: "59P1-99999",
          TaiXe: "Nguyễn Văn Xế",
          GiaoHang: "43R Hồ Văn Huê, Phú nhuận",
          SoLuong: "2",
        },
        {
          ID: "VD002",
  ...
  methods: {
    showModalListIMG() {
      setTimeout(() => {
        this.$bvModal.show("modal-list-img");
      }, 500);
    },
    showModalDSCT() {
      setTimeout(() => {
        this.$bvModal.show("modal-dsct");
      }, 500);
    },
    handleSelect(value) {
