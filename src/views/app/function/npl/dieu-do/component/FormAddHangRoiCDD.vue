<template>
  <div class="box-modal">
    <div class="box-card">
              ...
              <b-col :sm="12">
                <div class="d-flex mb-2">
                  ...
                  <v-select
                    ...
                    :options="['Không Cẩu', 'Tự Cẩu', 'Thuê Cẩu', 'Cẩu giúp']"
      ...
      <div>
        <strong>
          <span style="font-size: 13px">KẾ HOẠCH LẤY VÀ GIAO HÀNG</span></strong
        >
        <b-button
          class="ml-1 mb-1"
          squared
...
export default {
  ...
  data() {
    return {
      ...
      dataFormAdd: {
        ...
        SoLuongLay: 2,
        TrongLuongLay: 20,
        LayHang: "Kho Hàng ABC (55 Bà Rịa,Phường 9, TP. Vũng Tàu)",
  ...
  methods: {
    ...
    handleAddKeHoachLayGiao() {
      this.$refs.refKeHoachLayGiao.addItemList(this.dataFormAdd);
    },
    showModalAdd() {
