    ...
    >
      <b-row class="bg-light pt-2 mb-2">
        ...
        <b-col lg="12">
          <div class="text-info">
            <strong>
              <i class="fas fa-truck-loading mr-1"></i>ĐIỂM (CẢNG) LẤY RỖNG
            </strong>
          </div>
          <b-input-group prepend="Lấy hàng" class="t-input-group mb-3">
            <v-select
              style="width: 88%"
        ...
        <b-col lg="6">
          <b-input-group prepend="SL cont20" class="t-input-group mb-3">
            <b-form-input
              class="text-left"
              v-model="dataFormAdd.SoLuongLay"
            ></b-form-input>
          </b-input-group>
        </b-col>
        <b-col lg="6">
          <b-input-group prepend="SL cont40" class="t-input-group mb-3">
            <b-form-input
              class="text-left"
              v-model="dataFormAdd.TrongLuongLay"
            ></b-form-input>
          </b-input-group>
        </b-col>
        <b-col lg="12">
        ...
        <b-col lg="12">
          <div class="text-success">
            <strong>
              ...
              ĐIỂM ĐÓNG HÀNG</strong
            >
          </div>
          <b-input-group prepend="Giao hàng" class="t-input-group mb-3">
            <v-select
              style="width: 88%"
...
import KeHoachLayGiaoCX from "./KeHoachLayGiaoCX.vue";
...
export default {
  ...
  data() {
    return {
      ...
      dataFormAdd: {
        ...
        GiaoHang: "Cảng cát lái (43R Hồ Văn Huê, Phú Nhuận, HCM)",
      ...
      dataForm: this.data ?? {
        ...
        LayHang: "Cảng vũng tàu (55 Bà Rịa, TP. Vũng Tàu)",
        TraHang: "Cảng cát lái (43R Hồ Văn Huê, Phú Nhuận, HCM)",
        CauHang: null,
        DonViCau: null,
        Detail: [],
      },
  ...
  methods: {
    ...
    handleAddKeHoachLayGiao() {
      this.$refs.refKeHoachLayGiaoCX.addItemList(this.dataFormAdd);
    },
    showModalAdd() {
