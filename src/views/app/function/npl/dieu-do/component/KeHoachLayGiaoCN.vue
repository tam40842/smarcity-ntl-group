    ...
    <template v-for="(item, i) in arrKeHoachLayGiao">
      ...
      <b-row :key="i" class="bg-light pt-2 mb-2 position-relative mb-4">
        ...
        <b-col lg="12">
          <div class="text-info">
            <strong
              ><i class="fas fa-truck-loading mr-1"></i>ĐIỂM LẤY CONT</strong
            >
          </div>
          <b-row>
            <b-col lg="8">
        ...
        <b-col lg="12">
          <!-- <b-col lg="6">
              <div>
                <strong
                  ><i class="fas fa-file-alt mr-1"></i>DANH SÁCH MÃ LẤY CONT
                </strong>
              </div>
            </b-col> -->
          <div class="mb-2 d-flex">
            <strong><i class="fas fa-file-alt mr-1"></i>LẤY CONT </strong>
          </div>
          <b-row>
            <b-col lg="6" class="d-flex flex-nowrap">
              <b-input-group
                prepend="Cont1"
                class="t-input-group mb-3"
                style="display: flex; flex-wrap: nowrap"
        ...
        <!-- <b-col lg="12">
          <b-input-group prepend="Tgian DKiến" class="t-input-group mb-3">
            <b-form-input value="2022-15-12T06:00" ></b-form-input>
          </b-input-group>
        </b-col> -->
        <b-col lg="12">
