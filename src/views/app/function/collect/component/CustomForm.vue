                  ...
                  >
                    <b-form-group :label="dataForm[items][0] + ':'">
                      <treeselect
                        ...
                        :disable-branch-nodes="isBranchNode"
                        v-model="dataForm[items][1]"
                      />
                    </b-form-group>
                  </template>
          ...
          <template v-if="isCustomFooter">
            ...
            >
              <div class="d-flex flex-column">
                <div>{{ $t("refer-to-category-rules") }}:</div>
                <div>
                  <b-link
                    style="color: blue !important; text-decoration: underline"
                    target="_blank"
                    href="https://imgsmartcity.namlongtekgroup.com/TreeRouteReferences/document.pdf"
                    >https://imgsmartcity.namlongtekgroup.com/TreeRouteReferences/document.pdf</b-link
                  >
                </div>
              </div>
              <div>
...
export default {
  ...
  data() {
    return {
      ...
      isCustomFooter: this.pisCustomFooter ?? false,
      isBranchNode: this.pisBranchNode ?? false,
    };
  },
  watch: {
    avatar(to, from) {
