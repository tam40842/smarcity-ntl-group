...
import ClearanceHeightPopup from "@/views/app/map/popup-modals/ClearanceHeight";

export default {
  components: {
    "custom-table": CustomTables,
    "clearance-height": ClearanceHeightPopup,
  },
  data() {
    return {
      isShow: false,
      ...
      selectedItems: [],
      items: null,
      layerLoad: "ClearanceHeightMonitor",
      dataMapNow: null,
      dataModal: null,
    };
  },
  ...
  async created() {
    ...
    await this.getColumn("ClearanceHeightMonitor");
