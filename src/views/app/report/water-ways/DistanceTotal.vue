...
import DistanceTotalDetail from "./details/DistanceTotalDetail";

export default {
  components: {
    "custom-table": CustomTables,
    "custom-form": CustomForm,
    "distance-total-detail": DistanceTotalDetail,
  },
  data() {
    return {
      ...
      dataForm: null,
      isModalInfo: false,
      keyRowClass: "WATERWAYDISTANCE",
    };
  },
  watch: {
    items() {
      this.getColumn("WaterwayDistanceReports");
    },
  },
  methods: {
    infoModal(items) {
  ...
  async created() {
    ...
    await this.getColumn("WaterwayDistanceReports");
  },
  computed: {
    fields: function () {
