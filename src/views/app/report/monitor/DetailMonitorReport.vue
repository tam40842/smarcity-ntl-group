            ...
            <b-colxx lg="3">
              <b-form-group :label="$t('modal.location-option') + ':'">
                <b-form-select
                  ...
                  size="sm"
                  @change="
                    changeOption(selectedStation, selectedUnit, from, to)
                  "
                ></b-form-select>
              </b-form-group>
            </b-colxx>
            ...
            <b-colxx lg="3">
              <b-form-group :label="$t('modal.from-date') + ':'">
                <b-form-datepicker
                  ...
                  v-model="from"
                  required
                  @input="changeOption(selectedStation, selectedUnit, from, to)"
                ></b-form-datepicker>
              </b-form-group>
            </b-colxx>
            <b-colxx lg="3">
...
export default {
  ...
  methods: {
    changeOption(selected, unit, from, to) {
      this.getDataTable(selected, unit, from, to);
    },
    getOptionStation() {
      monitorAPI
        .monitorStationList()
