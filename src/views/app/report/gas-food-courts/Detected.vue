...
export default {
  ...
  data() {
    return {
      ...
      exportStatus: "close",
      typeFile: "Report-Detected-Total",
      titleForm: null,
      fromE: moment().format("YYYY-MM-DD"),
      toE: moment().format("YYYY-MM-DD"),
      selectedOption: "Report-Detected-Total",
      options: [
        {
          text: "Tổng hợp",
          value: "Report-Detected-Total",
        },
        {
          text: "Chi tiết",
          value: "Report-Detected-Details",
        },
      ],
    };
  },
    ...
    convertKeyTableData(array, ParentID, arrayTable = [], i) {
      array.forEach((item) => {
        ...
        let obj = {
          ...
          NumberDetected: item["NumberDetected"],
          Key: i,
        };
        arrayTable.push(obj);
