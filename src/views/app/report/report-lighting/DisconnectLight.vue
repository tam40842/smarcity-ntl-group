        ...
        <div class="top-right-button-container">
          <b-button-group>
            <b-dropdown right :text="$t('dropdown.action')" variant="primary">
              <b-dropdown-item @click="printExternalExcel('disconnect-light')">
                <i class="fad fa-file-excel"></i>
                &emsp;{{ $t("report.action.download-excel") }}x
              </b-dropdown-item>
            </b-dropdown>
          </b-button-group>
        </div>
...
export default {
  ...
  data() {
    return {
      timer,
      typeShowData: "DISCONNECT-REPORT-LIGHT",
      selectMode: "single",
