...
export default {
  ...
  watch: {
    items() {
      this.getColumn("ReportMaintenanceTotalLighting");
    },
  },
  methods: {
    // getOption() {
    ...
    convertKeyTableData(array, RegionParentID, arrayTable = [], i) {
      array.forEach((item) => {
        ...
        let obj = {
          ...
          MaintenanceRemain: item["MaintenanceRemain"],
          MaintenanceReturn: item["MaintenanceReturn"],
          MaintenanceTotal: item["MaintenanceTotal"],
          MaintenanceUpdate: item["MaintenanceUpdate"],
          MaintenanceComplete: item["MaintenanceComplete"],
          MaintenanceApproval: item["MaintenanceApproval"],
          Key: i,
        };
        arrayTable.push(obj);
  ...
  async created() {
    ...
    await this.getColumn("ReportMaintenanceTotalLighting");
    setTimeout(async () => {
